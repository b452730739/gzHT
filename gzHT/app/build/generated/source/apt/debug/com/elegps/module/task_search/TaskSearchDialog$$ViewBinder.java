...
public class TaskSearchDialog$$ViewBinder<T extends com.elegps.module.task_search.TaskSearchDialog> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2130968782, "field 'spStatus'");
    target.spStatus = finder.castView(view, 2130968782, "field 'spStatus'");
